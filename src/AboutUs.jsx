    ...
    return (
        <div className="about-us-container">
            ...
            <p className="about-us-description">
                Welcome to Healing Green, where green meets serenity!
            </p>
            <p className="about-us-content">
                At Healing Green, we are passionate about bringing nature closer
            ...
            <p className="about-us-content">
                ...
                Visit Healing Green today and experience the beauty of nature
